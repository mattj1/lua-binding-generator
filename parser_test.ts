...
let dataSourceOptions = {
    ...
    OnDefine: function(k, v) {
        ...
        if(v[0] == "CLITERAL" && v[2] == "Color") {
            e.DefStructConst(k, e.GetStructForName("Color"), { r:parseInt(v[5]), g:parseInt(v[7]), b:parseInt(v[9]), a:parseInt(v[11]) } )
        }
    }
}

let e = new Exporter();
let ds = new DataSource(rawData5, dataSourceOptions);
Parse(e, ds);
